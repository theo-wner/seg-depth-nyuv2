...
python train.py --task seg --name seg/exp3-lr --version larger --learning_rate 1e-6 --devices 2 1>/dev/null 2>> "$logfile"
echo "-------------------------------------------------------------------------" >> "$logfile" 2>&1
...
python train.py --task depth --name depth/exp3-lr --version larger --learning_rate 1e-6 --devices 2 1>/dev/null 2>> "$logfile"
echo "-------------------------------------------------------------------------" >> "$logfile" 2>&1
...
python train.py --task segdepth --name segdepth/exp3-lr --version larger --learning_rate 1e-6 --devices 2 1>/dev/null 2>> "$logfile"
echo "-------------------------------------------------------------------------" >> "$logfile" 2>&1
