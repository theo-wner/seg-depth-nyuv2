...
df_b2 = pd.read_csv('../results/results_training_segdepth_iou/exp1-backbone_b2.csv')
df_b3 = pd.read_csv('../results/results_training_segdepth_iou/exp1-backbone_b3.csv')
df_b4 = pd.read_csv('../results/results_training_segdepth_iou/exp1-backbone_b4.csv')
df_b5 = pd.read_csv('../results/results_training_segdepth_iou/exp1-backbone_b5.csv')
