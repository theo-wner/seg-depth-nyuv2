...
train_time = [2.023, 2.288, 3.704, 4.642, 5.738, 6.663] # in hours
inf_time = [6.75, 7.76, 17.05, 23.28, 30.36, 37.62] # in milliseconds
inf_std = [1.24, 1.23, 1.02, 1.04, 1.08] # in milliseconds
