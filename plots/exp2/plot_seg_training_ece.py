...
df_fff = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp2/seg/fff_ece.csv')
df_ttf = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp2/seg/ttf_ece.csv')
...
plt.savefig('./images/seg_training_ece_exp2.png', dpi=300)
