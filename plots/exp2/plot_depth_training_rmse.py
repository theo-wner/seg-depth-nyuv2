...
df_fff = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp2/depth/fff.csv')
df_ttf = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp2/depth/ttf.csv')
...
plt.savefig('./images/depth_training_rmse_exp2.png', dpi=300)
