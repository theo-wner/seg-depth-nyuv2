...
ax1.plot(backbones, inf_time_seg, marker='o', color='#0072BD', label='Segmentierung')  # Darker blue
ax1.plot(backbones, inf_time_depth, marker='o', color='#D95319', label='Tiefenschätzung')  # Darker orange
ax1.plot(backbones, inf_time_segdepth, marker='o', color='#EDB120', label='Simultan')  # Darker yellow
ax1.plot(backbones, inf_time_segplusdepth, marker='o', color='#7E2F8E', label='Summiert')  # Darker pursple
...
ax1.set_ylabel('Inferenzzeit in ms')
...
plt.savefig('./images/all_end_inftime.png', dpi=300)
