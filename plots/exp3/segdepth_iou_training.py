...
smaller = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp3/segdepth/smaller_iou.csv')
normal = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp1/results_training_segdepth_iou/exp1-backbone_b3.csv')
larger = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp3/segdepth/larger_iou.csv')
...
plt.savefig('./images/exp3_segdepth_iou_training', dpi=300)
