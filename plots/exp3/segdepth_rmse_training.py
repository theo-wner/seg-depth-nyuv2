...
smaller = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp3/segdepth/smaller_rmse.csv')
normal = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp1/results_training_segdepth_rmse/exp1-backbone_b3.csv')
larger = pd.read_csv('/home/tkapler/Dokumente/Studium/Bachelorarbeit/Code/seg-depth-nyuv2/results/exp3/segdepth/larger_rmse.csv')
...
plt.savefig('./images/exp3_segdepth_rmse_training', dpi=300)
